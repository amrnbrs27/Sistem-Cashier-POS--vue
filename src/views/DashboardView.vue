<template>
  <div class="lg:flex">
    ...
    <div class="flex-1 p-4 lg:p-6 bg-gray-100 min-h-screen">
      ...
      <p class="text-gray-500 mt-1">Statistik penjualan toko</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 mt-8">
        ...
        <div class="bg-white rounded-3xl p-6">
          ...
          <h1 class="text-3xl font-bold mt-3 text-green-500">
            {{ formatRupiah(totalRevenue) }}
          </h1>
        </div>

        <div class="bg-white rounded-3xl p-6">
          <p class="text-gray-500">Profit Bersih</p>

          <h1 class="text-3xl font-bold mt-3 text-blue-500">
...
const totalProfit = computed(() => {
  ...
  return totalRevenue.value - totalExpense;
});
